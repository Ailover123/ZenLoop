...
import { UnifiedPomodoroTimer } from '../components/UnifiedPomodoroTimer';
import { UnifiedDocumentManager } from '../components/UnifiedDocumentManager';
import { exportToPDF } from '../utils/pdfExporter';
import useStore from '../store/useStore';

export function ZenCodeRoomClean() {
            ...
            <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-2xl">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-white flex items-center">
                  ...
                  Tasks ({zenCodeTasks.filter(t => t.roomId === zenCode).length})
                </h2>
              ...
              <UnifiedPomodoroTimer mode="zen-code" roomId={zenCode} />
            </div>
...
export default ZenCodeRoomClean;
